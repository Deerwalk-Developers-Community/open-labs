...
<LabHeader title={frontmatter.title} collegeName={frontmatter.college_name} course={frontmatter.course} semester={frontmatter.semester} doneBy={frontmatter.doneBy}/>
--------------------
